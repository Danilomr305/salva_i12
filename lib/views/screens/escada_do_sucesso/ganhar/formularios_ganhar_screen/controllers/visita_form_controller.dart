...
import '../../../../../../data/provider/escada_do_sucesso_provider/ganhar/visitas_provider.dart';
...
// Encontre o objeto DescendenciaModels completo a partir do ID selecionado
    ...
    /*final descendenciaDoFormulario = DescendenciaModels(
      id: descendenciaSelecionada.id,
      descricao: descendenciaSelecionada.descricao,
      sigla: descendenciaSelecionada.sigla,
    ...
    // Crie uma instância de DescendenciaModels
    final descendenciaDoFormulario = DescendenciaModels(
      id: controllerIdDescendencia.text.isNotEmpty
      ...
      descritionDto: Descrition(
          id: controllerIdDescendencia.text,
          descricao: controllerDescendencia.text),
    );*/
    ...
    final novaVisita = VisitaDetalheModels(
      id: '',
      pessoa: pessoa,
