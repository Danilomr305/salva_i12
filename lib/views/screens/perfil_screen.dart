...
import 'package:i12mobile/views/widgets/button_whatsapp_widgets.dart';
...
import '../widgets/foto_de_perfil_______.dart';
...
class _PerfilScreenState extends State<PerfilScreen> {
  ...
  final String phoneNumber = "5586988362901";
  final String message = "Olá, gostaria de saber mais sobre os seus serviços.";
  ...
  // Função para direcionar para o whatsapp da empressa com uma mensagem pre-pronta
