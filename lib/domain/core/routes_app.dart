...
import 'package:i12mobile/views/screens/formularios_screen/descendencia_form.dart';
...
import 'package:i12mobile/views/screens/formularios_screen/visita_form.dart';
import 'package:i12mobile/views/screens/visualizacao_screen/visita_view.dart';
import 'package:i12mobile/views/screens/paginas_screen/visita_page.dart';
import 'package:i12mobile/views/screens/formularios_screen/rota_da_vida_form.dart';
import 'package:i12mobile/views/screens/paginas_screen/rota_da_vida_page.dart';
import 'package:i12mobile/views/screens/login_screen.dart';
import 'package:i12mobile/views/screens/home_screen.dart';
import 'package:i12mobile/views/screens/formularios_screen/pessoa_form.dart';
import 'package:i12mobile/views/screens/paginas_screen/pessoa_paginas.dart';
import 'package:i12mobile/views/screens/visualizacao_screen/pessoa_view.dart';
import 'package:i12mobile/views/screens/perfil_screen.dart';
import '../../views/screens/paginas_screen/descendencia_page.dart';
import '../../views/screens/visualizacao_screen/descendencia_view.dart';
...
final routes = GoRouter(initialLocation: '/boasVindas', routes: [
  ...
  GoRoute(
    path: '/createrVisitante',
    builder: (context, state) => const NovaVidaForm(),
  ),
  GoRoute(
  ...
  GoRoute(
    path: '/novaVida',
    builder: (context, state) => const NovaLifePage(),
  ),
  GoRoute(
    path: '/descendencia',
